        ...
        items: [
            {
                ...
                path: '/cafm',
                icon: <HomeWorkIcon />,
                roles: ['admin', 'manager', 'hr', 'facility manager', 'technician', 'helpdesk operator', 'client user'],
                children: [
                    { label: 'Overview', path: '/cafm', icon: <AssessmentIcon />, roles: ['admin', 'manager', 'hr', 'facility manager', 'helpdesk operator'] },
                    { label: 'Facilities', path: '/cafm/facilities', icon: <BusinessIcon />, roles: ['admin', 'manager', 'hr', 'facility manager'] },
